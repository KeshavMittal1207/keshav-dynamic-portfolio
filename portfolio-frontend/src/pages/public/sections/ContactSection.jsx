      ...
      <div className="contact-grid grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-12 items-start">
        ...
        <div className="select-text">
          ...
          <div className="flex flex-col select-none">
            <a href="mailto:keshavmittal1207@gmail.com" className="clink">
              <div 
              ...
              <div>
                ...
                <div className="clink-val select-all">keshavmittal1207@gmail.com</div>
              </div>
            </a>
            
            <a href="https://www.linkedin.com/in/keshav-mittal-8b2b81284/" target="_blank" rel="noreferrer" className="clink">
              <div 
                className="clink-ico flex items-center justify-center" 
              ...
              <div>
                ...
                <div className="clink-val">keshav mittal</div>
              </div>
            </a>
            
            <a href="https://github.com/KeshavMittal1207" target="_blank" rel="noreferrer" className="clink">
              <div 
                className="clink-ico flex items-center justify-center" 
              ...
              <div>
                ...
                <div className="clink-val">KeshavMittal1207</div>
              </div>
            </a>
            
            <a href="https://leetcode.com/u/keshav06/" target="_blank" rel="noreferrer" className="clink">
              <div 
                className="clink-ico flex items-center justify-center" 
              ...
              <div>
                ...
                <div className="clink-val">keshav06</div>
              </div>
            </a>
          </div>
        </div>
